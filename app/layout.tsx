...
export const metadata: Metadata = {
  ...
  keywords: ['σχολή οδηγών', 'Δήμητρα Χριστοθανοπούλου', 'DC Drive', 'δίπλωμα οδήγησης', 'Αθήνα', 'κατηγορία Β', 'μοτοσυκλέτα', 'επαγγελματικό δίπλωμα', 'σχολή οδηγών Αθήνα', 'σχολή οδηγών Περιστέρι', 'δίπλωμα οδήγησης Περιστέρι', 'ανανέωση διπλώματος', 'μετεκπαίδευση'],
  ...
  openGraph: {
    ...
    title: 'Σχολή Οδηγών Δήμητρα Χριστοθανοπούλου — Περιστέρι, Αθήνα',
    description: 'Σχολή οδηγών Δήμητρα Χριστοθανοπούλου στο Περιστέρι Αθήνας. Διπλώματα Β, Α, Γ, Δ. Εμπειρία από το 1979.',
    images: [
      {
