      ...
      <div style={{
        ...
        <motion.div
          ...
          <p style={{
            ...
            Η σχολή ιδρύθηκε το 1979 από τον πατέρα μου, Δημήτρη Χριστοθανόπουλο. Εντάχθηκα στο δυναμικό της το 2008 και από τότε συνεχίζω τον ίδιο σκοπό: τη σωστή εκπαίδευση και την επίτευξη άριστης οδικής συμπεριφοράς.
          </p>
          ...
          <p style={{
            ...
            Διαθέτουμε σύγχρονο Κέντρο Θεωρητικής Εκπαίδευσης με οπτικοακουστικά μέσα και υπολογιστές, καθώς και οχήματα για όλες τις κατηγορίες, συμπεριλαμβανομένου αυτόματου εκπαιδευτικού οχήματος.
          </p>
