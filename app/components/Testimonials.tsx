...
const testimonials = [
  { text: 'Μετά από δύο αποτυχημένες προσπάθειες να μάθω να οδηγώ, ευτυχώς βρήκα την Δήμητρα και τα κατάφερα! Ήρεμη, μεταδοτική, σε κάνει να νιώθεις ασφάλεια. Καταπληκτική!', name: 'Πηνελόπη' },
  { text: 'Η Δήμητρα είναι εξαιρετική δασκάλα, υπομονετική και μεταδοτική! Η ηρεμία της σε κάνει να αισθάνεσαι ασφάλεια και σιγουριά — πολύ σημαντικό όταν πιάνεις το τιμόνι για πρώτη φορά!', name: 'Μαρία' },
  { text: 'Μετά από αναβλητικότητα χρόνων αποφάσισα να πάω σε αυτή τη σχολή. Η Δήμητρα είναι φοβερή στη δουλειά της, με επαγγελματισμό και καλή διάθεση — σε κάνει να μην θες να τελειώσουν τα μαθήματα!', name: 'Vaso' },
  { text: 'Εξαιρετική η εμπειρία μου! Η Δήμητρα είναι δασκάλα που σου εμπνέει εμπιστοσύνη από την πρώτη στιγμή και σε διδάσκει πώς να είσαι πραγματικά σωστός οδηγός. Την προτείνω ανεπιφύλακτα!', name: 'Artemis' },
  { text: 'Παρόλο που πήγα για δίπλωμα σε σχετικά μεγάλη ηλικία, με έκανε να αισθανθώ πολύ άνετα από την αρχή και να ξεπεράσω όλους τους φόβους μου. Δήμητρα σε ευχαριστώ για όλα!', name: 'Filio' },
  { text: 'Η καλύτερη δασκάλα που θα μπορούσα να έχω! Μεταδοτική και ήρεμη — πράγμα που σου προσφέρει αίσθημα σιγουριάς και ασφάλειας κατά τη διάρκεια του μαθήματος.', name: 'Theodora' },
]
